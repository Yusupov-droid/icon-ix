...
;// CONCATENATED MODULE: ./src/icon-ix/collection.js
/* harmony default export */ var collection = ([{
  ...
  "search": ["antibiotic", "antibody", "covid-19", "health", "organism", "sick"]
}, {
  ...
  "value": "fas fa-expand",
  "search": ["bigger", "enlarge", "fullscreen", "resize"]
}, {
  "value": "fas fa-expand-alt",
  "search": ["arrows", "bigger", "enlarge", "fullscreen", "resize"]
}, {
  "value": "fas fa-expand-arrows-alt",
  "search": ["bigger", "enlarge", "fullscreen", "move", "resize"]
}, {
  ...
  "value": "fas fa-sink",
  "search": ["bathroom", "covid-19", "faucet", "kitchen", "wash"]
}, {
  ...
  "search": ["disband", "friends", "group", "people", "persons", "profiles", "separate", "team", "ungroup"]
}, {
  "value": "fab fa-usps",
...
var _pickerElement = /*#__PURE__*/new WeakMap();

var _outputElement = /*#__PURE__*/new WeakMap();
...
var _create = /*#__PURE__*/new WeakMap();
...
var _getRole = /*#__PURE__*/new WeakMap();

var _getElement = /*#__PURE__*/new WeakMap();

var _getIconSet = /*#__PURE__*/new WeakMap();

var _pushIcons = /*#__PURE__*/new WeakMap();

var _searchIcons = /*#__PURE__*/new WeakMap();

var IconIx = function IconIx(_selector, option, paginator) {
  var _this = this;
  ...
  _pickerElement.set(this, {
    writable: true,
    value: null
  });

  _outputElement.set(this, {
    writable: true,
    value: null
  });

  _previewElement.set(this, {
    writable: true,
    value: null
  });
  ...
  _init.set(this, {
    ...
    value: function value() {
      _classPrivateFieldSet(_this, _icons, _classPrivateFieldGet(_this, _getIconSet).call(_this));

      _this.modalRootElement = _classPrivateFieldGet(_this, _create).call(_this);
      _this.modalCloseElemenet = _classPrivateFieldGet(_this, _getRole).call(_this, "close");
      _this.modalSearchElemenet = _classPrivateFieldGet(_this, _getRole).call(_this, "search");
      _this.modalPaginateNextElement = _classPrivateFieldGet(_this, _getRole).call(_this, "next");
      _this.modalPaginatePrevElement = _classPrivateFieldGet(_this, _getRole).call(_this, "prev");
      _this.modalPaginateInfoElement = _classPrivateFieldGet(_this, _getRole).call(_this, "info");
      _this.modalIconContainerElement = _classPrivateFieldGet(_this, _getRole).call(_this, "container");
  ...
  _sync.set(this, {
    ...
    value: function value() {
      ...
      root.style.setProperty("--pc-icon-size", _classPrivateFieldGet(_this, _option).style.icon.size);
      root.style.setProperty("--pc-icon-margin", _classPrivateFieldGet(_this, _option).style.icon.margin);
      root.style.setProperty("--pc-icon-padding", _classPrivateFieldGet(_this, _option).style.icon.padding);
      root.style.setProperty("--pc-icon-font-size", _classPrivateFieldGet(_this, _option).style.icon.fontSize);
      root.style.setProperty("--pc-first-color", _classPrivateFieldGet(_this, _option).style.color.first);
      root.style.setProperty("--pc-third-color", _classPrivateFieldGet(_this, _option).style.color.third);
      root.style.setProperty("--pc-second-color", _classPrivateFieldGet(_this, _option).style.color.second);
      root.style.setProperty("--pc-fourth-color", _classPrivateFieldGet(_this, _option).style.color.fourth);
    }
  });
  ...
  _start.set(this, {
    ...
    value: function value() {
      ...
      _this.modalRootElement.addEventListener("click", _classPrivateFieldGet(_this, _onClose));

      _this.modalCloseElemenet.addEventListener("click", _classPrivateFieldGet(_this, _onClose));

      _this.modalSearchElemenet.addEventListener("input", _classPrivateFieldGet(_this, _onSearch));

      _this.modalIconContainerElement.addEventListener("click", _classPrivateFieldGet(_this, _onIcon));

      _this.modalPaginateNextElement.addEventListener("click", _classPrivateFieldGet(_this, _onPaginate));

      _this.modalPaginatePrevElement.addEventListener("click", _classPrivateFieldGet(_this, _onPaginate));
  ...
  _destroy.set(this, {
    ...
    value: function value() {
      ...
      _this.modalRootElement.removeEventListener("click", _classPrivateFieldGet(_this, _onClose));

      _this.modalCloseElemenet.removeEventListener("click", _classPrivateFieldGet(_this, _onClose));

      _this.modalSearchElemenet.removeEventListener("input", _classPrivateFieldGet(_this, _onSearch));

      _this.modalIconContainerElement.removeEventListener("click", _classPrivateFieldGet(_this, _onIcon));

      _this.modalPaginateNextElement.removeEventListener("click", _classPrivateFieldGet(_this, _onPaginate));

      _this.modalPaginatePrevElement.removeEventListener("click", _classPrivateFieldGet(_this, _onPaginate));
  ...
  _onIcon.set(this, {
    ...
    value: function value(event) {
      ...
      if (role === "icon") {
        ...
        _classPrivateFieldGet(_this, _outputElement).value = data;
        _classPrivateFieldGet(_this, _previewElement).innerHTML = "<i class=\"".concat(data, "\"></i>");
  ...
  _onSearch.set(this, {
    writable: true,
    value: function value(event) {
      _classPrivateFieldGet(_this, _searchIcons).call(_this, event.target.value);
  ...
  _getRole.set(this, {
    writable: true,
    value: function value(rolename) {
      return _this.modalRootElement.querySelector("[picker-role=\"".concat(rolename, "\"]"));
    }
  });

  _getElement.set(this, {
    writable: true,
  ...
  _pushIcons.set(this, {
    writable: true,
    value: function value() {
      _classPrivateFieldGet(_this, _paginator).page_count = Math.ceil(_classPrivateFieldGet(_this, _icons).length / _classPrivateFieldGet(_this, _paginator).page_size);
      _this.modalPaginateInfoElement.innerHTML = _classPrivateFieldGet(_this, _paginator).page + "/" + _classPrivateFieldGet(_this, _paginator).page_count;

      var result = _classPrivateFieldGet(_this, _icons).slice((_classPrivateFieldGet(_this, _paginator).page - 1) * _classPrivateFieldGet(_this, _paginator).page_size, _classPrivateFieldGet(_this, _paginator).page * _classPrivateFieldGet(_this, _paginator).page_size);

      _this.modalIconContainerElement.innerHTML = result.map(function (e) {
        return "<a picker-role='icon' data-icon=\"".concat(e.value, "\"><i class='").concat(e.value, "'></i></a>");
      }).join("");
    }
  });

  _searchIcons.set(this, {
    writable: true,
    value: function value(search) {
      if (!search) {
        _classPrivateFieldSet(_this, _icons, _classPrivateFieldGet(_this, _getIconSet).call(_this));
      } else {
        _classPrivateFieldSet(_this, _icons, _classPrivateFieldGet(_this, _getIconSet).call(_this).filter(function (elem) {
          return elem.search.find(function (e) {
            return e.includes(search);
          }) ? elem : null;
        }));

        _classPrivateFieldGet(_this, _paginator).page = 1;
      }
    }
  });
  ...
  _classPrivateFieldSet(this, _outputElement, _classPrivateFieldGet(this, _getElement).call(this, _classPrivateFieldGet(this, _option).output));

  _classPrivateFieldSet(this, _previewElement, _classPrivateFieldGet(this, _getElement).call(this, _classPrivateFieldGet(this, _option).preview));

  _classPrivateFieldGet(this, _pickerElement).addEventListener("click", _classPrivateFieldGet(this, _init));
};

_defineProperty(IconIx, "option", {
  tittle: "IconIx",
  output: "#output",
  preview: "#preview",
  style: {
...
_defineProperty(IconIx, "paginator", {
  page: 1,
  page_size: 50,
  page_count: 20
});
